...
@Mod("k7a2dlc")
public class K7a2dlcMod {
	public static final Logger LOGGER = LogManager.getLogger(K7a2dlcMod.class);
	public static final String MODID = "k7a2dlc";
	...
	public K7a2dlcMod() {
		...
		K7a2dlcModTabs.REGISTRY.register(bus);

		K7a2dlcModMenus.REGISTRY.register(bus);
	}
